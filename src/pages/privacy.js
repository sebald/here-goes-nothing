...
const Privacy = ({ location, siteTitle }) => (
  <Layout location={location} title={siteTitle}>
    <SEO title="GDPR Privacy Policy" />
    <main>
      <h1>Privacy Policy for "Here Goes Nothing"</h1>

      <p>
        At "Here Goes Nothing", accessible from
        https://sebald.github.io/here-goes-nothing/, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by Here Goes Nothing
        and how we use it.
      </p>
      ...
      <p>
        Sebastian Sebald legal basis for collecting and using the personal
      ...
      <ul>
        <li>Sebastian Sebald needs to perform a contract with you</li>
        <li>You have given Sebastian Sebald permission to do so</li>
        <li>
          Processing your personal information is in Sebastian Sebald legitimate
          interests
        </li>
        <li>Sebastian Sebald needs to comply with the law</li>
      </ul>

      <p>
        Sebastian Sebald will retain your personal information only for as long
      ...
      <p>
        Here Goes Nothing follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Here Goes Nothing uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertising partners of Here Goes Nothing.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Here Goes Nothing, which are
      ...
      <p>
        Note that Here Goes Nothing has no access to or control over these
      ...
      <p>
        Here Goes Nothing's Privacy Policy does not apply to other advertisers
      ...
      <p>
        Here Goes Nothing does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        to the information that they shared and/or collect in Here Goes Nothing.
